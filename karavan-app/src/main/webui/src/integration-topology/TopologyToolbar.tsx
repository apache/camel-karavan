...
import {useTopologyHook} from '@/integration-topology/useTopologyHook';
import {useRouteDesignerHook} from "@/integration-designer/route/useRouteDesignerHook";
...
export function TopologyToolbar() {
    ...
    const {createNewRestFile, createNewBean, createRouteConfiguration, createOpenApiJsonFile, isOpenApiExists, createNewKamelet, isAsyncApiExists, createAsyncApiJsonFile}  = useProjectFunctions();
