...
export class KaravanApi {
    ...
    static async deleteProjectFileByName(projectId: string, filename: string, after: (res: AxiosResponse<any>) => void) {
        instance.delete(`/ui/file/${projectId}/${filename}`)
            .then(res => {
                after(res);
            }).catch(err => {
            after(err);
    ...
    static async getProjectCamelStatuses(projectId: string, after: (res: AxiosResponse<CamelStatus[]>) => void) {
        instance.get(`/ui/project/status/camel/${projectId}` )
            .then(res => {
                after(res);
            }).catch(err => {
            after(err);
    ...
    static async getProjectCamelTraces(projectId: string, after: (res: AxiosResponse<CamelStatus[]>) => void) {
        instance.get(`/ui/project/traces/${projectId}`)
            .then(res => {
                after(res);
            }).catch(err => {
            after(err);
    ...
    static async getContainerStatus(projectId: string, after: (res: AxiosResponse<ContainerStatus[]>) => void) {
        instance.get(`/ui/container/${projectId}`)
            .then(res => {
                after(res);
            }).catch(err => {
            after(err);
    ...
    static async getAllDeploymentStatuses(): Promise<DeploymentStatus[]> {
        try {
            const res = await instance.get('/ui/infrastructure/deployment');
