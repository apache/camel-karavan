...
import {DeleteProjectModal} from "@/integrations/DeleteProjectModal";
...
import {ProjectsTableRow} from "@/integrations/ProjectsTableRow";
import {useProjectFunctions} from "@/integration/ProjectContext";
import {ProjectsToolbar} from "@/integrations/ProjectsToolbar";
...
export function ProjectsPage() {
    ...
    const { refreshSharedData } = useProjectFunctions();
