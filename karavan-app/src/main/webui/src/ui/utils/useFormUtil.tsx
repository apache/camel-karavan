...
export function useFormUtil(formContext: UseFormReturn<any>) {
                ...
                <Controller
                    ...
                    render={() => (
                        <div style={{display: 'flex'}}>
                            ...
                            />
                            <Button variant="control" onClick={_ => setShowPassword(!showPassword)}>
    ...
    return {getFormSelect, getTextField, getSwitches, getTextFieldPrefix, getTextArea, getPasswordField, getTextFieldSuffix, getTextFieldReadOnly}
}
