...
export function cleanMarkdownBackticks(code: string | null | undefined): string | null | undefined {
    if (!code) {
        return code;
    }
...
export function extractMarkdownLanguage(code: string | null | undefined): string | null {
    if (!code) {
        return null;
    }
    // Captures any letters/numbers immediately following ``` at the start of a line
