...
export function RouteDesigner() {
    ...
    const {openSelector, createRouteConfiguration, unselectElement, onAddNewRouteStep, isActionKamelet, isKamelet, isSinkKamelet} = useRouteDesignerHook();
    ...
    const [showPalette] = useCommandPaletteStore((s) => [s.showPalette], shallow)
                ...
                {showNewRoute && <Button
                    ...
                    onClick={evt => {
                        ...
                        if (isSinkKamelet() || isActionKamelet()) {
                            ...
                            onAddNewRouteStep(dsl, '', undefined);
                        } else {
        ...
        return (
            <div className="graph" ref={printerRef}>
                ...
                <div id="flows"
                    ...
                    {!isDebugging && isDev && getGraphButtons()}
                </div>
            </div>)
    }
