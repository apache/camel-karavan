...
export function AmqpIcon() {
    return (
        ...
        >
            ...
            <path
                fill="#000"
                d="m.027 110.87.02-19.535c0-2.731 0-5.461.006-8.198 0-.212.033-.43.053-.729h1.405c26.904 0 53.808-.006 80.712 0 .543 0 1.087.1 1.623.153 1.803 1.875 3.565 3.797 5.414 5.626 2.989 2.949 6.044 5.825 9.046 8.747 1.06 1.034 2.041 2.154 3.108 3.187 2.133 2.068 4.307 4.096 6.441 6.157 2.551 2.465 5.082 4.943 7.627 7.421l.47.53.02.285-.02-.046-.046.013-.252.04c-.113.053-.225.113-.331.166l-.504.079c.007-.04.013-.079.02-.112-.272-.603-1.173-.67-1.67-.133-.987.02-1.975.04-2.969.066l-4.658-.046c-.259-.06-.517-.172-.769-.166-1.292.04-2.584.106-3.876.166h-.815c-.497 0-1.001-.013-1.498-.02-.166-.053-.331-.106-.497-.166H18.919c-.285 0-.563.113-.848.173-.378-.053-.75-.166-1.127-.153-1.279.027-2.558.1-3.837.153h-.676c-4.081-.007-8.163-.02-12.245-.027-.047-.212-.1-.424-.146-.636 0-.113 0-.225-.007-.338l.08-.689c-.02-.1-.033-.199-.053-.305-.02-.06-.033-.119-.053-.172 0-.166 0-.332-.007-.497 0-.219.013-.444.02-.663v-.331z"
            />
            <path
                fill="#c9cbce"
                d="M115.488 113.699c-2.538-2.471-5.076-4.956-7.627-7.422-2.14-2.06-4.314-4.088-6.441-6.156-1.067-1.033-2.04-2.153-3.108-3.187-3.008-2.929-6.063-5.805-9.045-8.747-1.849-1.829-3.611-3.744-5.414-5.626V.166c.146-.02.225-.047.245-.027.71.862 1.657.915 2.69.915 9.192-.027 18.383-.014 27.574-.014 1.299 0 1.299 0 1.299 1.279v107.232c0 .497.006.994.013 1.491 0 .384-.013.775-.02 1.16-.053.503-.113 1.007-.166 1.504z"
            />
            <path
                fill="#002485"
                d="M74.59 73.231c0 .119.006.331-.014.338-.272.039-.55.066-.822.066H1.36c-.219 0-.444.013-.663.02H.18c-.046-.259-.132-.517-.132-.775-.007-10.239-.014-20.477 0-30.715 0-.278.199-.55.305-.828.178.02.364.04.543.053.046 0 .086.013.113.053 0 .848.583.848 1.199.848h38.328c.272 0 .537-.026.908-.04v-.868l.636.04c.219.206.438.411.65.616l13.233 13.075c3.254 3.214 6.514 6.427 9.774 9.635 2.611 2.571 5.229 5.135 7.84 7.7.337.265.669.53 1.007.795z"
            />
            <path
                fill="#a1afd9"
                d="M73.582 72.435c-2.61-2.564-5.228-5.129-7.84-7.7A6480.73 6480.73 0 0 1 55.97 55.1c-4.414-4.353-8.82-8.714-13.234-13.074-.212-.212-.43-.411-.65-.616 0-5.567.014-11.14.02-16.706V0c.743.331 1.366.616 1.989.895.086.086.159.238.252.245 1.186.112 2.379.278 3.571.291 5.189.034 10.378.027 15.566.02 3.161-.006 6.322-.046 9.483-.099.325 0 .643-.219.96-.338.113.331.22.669.332 1.001.04.669.073 1.338.113 2.001-.007.159-.02.324-.027.483-.702.073-.417.623-.417.968-.014 20.304-.014 40.608-.014 60.905v3.737z"
            />
            <path
                fill="#000"
                d="M31.987 31.536c.205.239.417.477.749.862H29.74c-9.356 0-18.707.013-28.063.013H1.43C.491 32.428.02 31.945.02 30.96c.013-9.795.027-19.589.053-29.383 0-.397.066-.795.113-1.312.662.583 1.16 1.014 1.656 1.451.146.219.265.471.45.656 2.512 2.512 5.024 5.03 7.562 7.522 1.213 1.186 2.498 2.299 3.698 3.492 2.266 2.246 4.472 4.546 6.739 6.785 1.955 1.929 3.956 3.804 5.924 5.719 1.928 1.876 3.843 3.764 5.765 5.646z"
            />
            <path
                fill="#c9cbce"
                d="M31.986 31.536c-1.921-1.882-3.836-3.77-5.765-5.646-1.968-1.915-3.976-3.79-5.924-5.718-2.266-2.24-4.48-4.54-6.74-6.786-1.205-1.193-2.49-2.306-3.697-3.492-2.538-2.492-5.05-5.01-7.56-7.522-.186-.185-.299-.437-.451-.656.642-.835 1.623-.622 2.432-.642 3.498-.08 7.004-.04 10.51-.04h16.3c1.16 0 1.247.086 1.247 1.213 0 9.211 0 18.422-.02 27.632 0 .551-.212 1.101-.318 1.657z"
            />
            </g>
        </svg>
    )
...
export function ActivemqIcon(width: number = 32, height: number = 32) {
    return (
        <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 30.803 44.324"
            className="icon" width={width} height={width}>
            <defs>
                <filter
                    id="a"
                    width={1.068}
...
export function KafkaIcon(width: number = 32, height: number = 32) {
    return (
        <svg
            xmlns="http://www.w3.org/2000/svg"
            preserveAspectRatio="xMidYMid"
...
export function MachineLearningIcon(props: {width?: number | string, height?: number | string}) {
