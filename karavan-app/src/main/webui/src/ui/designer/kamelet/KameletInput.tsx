...
import {capitalize, FormGroup, GridItem, InputGroup, InputGroupItem, InputGroupText, TextArea, TextInput, ToggleGroup, ToggleGroupItem} from "@patternfly/react-core";
import '../karavan.css';
import './kamelet.css';
