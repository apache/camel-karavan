...
export function ProjectFunctionHook() {
    ...
    function createOpenApiJsonFile() {
        createOpenApiJsonFileForProject(project.projectId)
    }

    function createOpenApiJsonFileForProject(projectId: string) {
        try {
        } catch (e: any) {
            EventBus.sendAlert("Error creating file", e.message, "danger");
        }
    ...
    function createOpenApiForProject(projectId: string) {
        ...
        createOpenApiJsonFileForProject(projectId);
    }
    ...
    return {createNewRouteFile, createOpenApiRestFile, createNewBean, createNewKamelet, createRouteConfiguration, refreshSharedData,
        createAsyncApi, isOpenApiExists, createNewRestFile, refreshData, isAsyncApiExists, createOpenApi, project, createOpenApiForProject, saveFiles}
}
