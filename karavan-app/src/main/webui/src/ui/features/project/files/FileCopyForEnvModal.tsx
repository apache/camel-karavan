...
import {Button, Content, ContentVariants, Modal, ModalFooter, ModalHeader, ModalVariant, ToggleGroup, ToggleGroupItem,} from '@patternfly/react-core';
        ...
        >
            <ModalHeader>
                <div style={{display: 'flex', flexDirection: 'row', gap: '6px', alignItems: 'center'}}>
                    <Content component={ContentVariants.h3}>Copy <b>{file?.name}</b></Content>
                </div>
                <div style={{display: 'flex', flexDirection: 'row', gap: '6px', alignItems: 'center'}}>
                    <Content component={ContentVariants.h3} style={{margin: 0}}>Environment:</Content>
                    {getEnvs()}
                </div>
            </ModalHeader>
            <ModalFooter>
