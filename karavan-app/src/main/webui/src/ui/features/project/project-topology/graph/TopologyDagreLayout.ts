...
import {BendpointConfig, TopologyLink} from "@features/project/project-topology/graph/TopologyLink";
import {TopologyGroup} from "@features/project/project-topology/graph/TopologyGroup";
