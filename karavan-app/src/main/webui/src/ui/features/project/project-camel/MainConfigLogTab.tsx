...
import '../integration-runtime/ProjectLog.css';
import {Table, Tbody, Td, Th, Thead, Tr} from "@patternfly/react-table";
import {Bullseye, Content, Spinner} from "@patternfly/react-core";
import {APPLICATION_PROPERTIES} from "@models/ProjectModels";
import {MainConfiguration} from "@features/project/project-camel/RuntimeModels";
