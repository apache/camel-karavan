...
import {CubeIcon, ErrorCircleOIcon, TimesCircleIcon} from "@patternfly/react-icons";
...
export function ContainerEnvironmentPanel(props: Props) {
    ...
    return (
        <Flex justifyContent={{default: "justifyContentSpaceBetween"}}
            ...
            <FlexItem>
                {conts.length === 0 && <Label icon={<ErrorCircleOIcon/>} color={"grey"}>{noContainersText}</Label>}
                    ...
                    {conts.map((cs: ContainerStatus, index) => {
                            ...
                            return (
                                <div style={{display: 'flex', gap: '8px'}} key={index}>
                                    ...
                                    <Label icon={<CubeIcon/>} color={ready ? "green" : "grey"} variant='outline'>
                                        Image:
