...
export type ProjectPageSideBarType = 'route' | 'openAPI' | 'jsonSchema' | 'json' | 'templatedRoute' | 'dependency' | any | null;
...
export const useProjectPageStore = createWithEqualityFn<ProjectPageState>((set, get) => ({
    showSideBar: null,
