...
import {ComponentHeader, ComponentProperty} from "@karavan-core/model/ComponentModels";
import {useDocumentationStore} from "../../../stores/DocumentationStore";
import {shallow} from "zustand/shallow";

export function ComponentModal() {

    const [component, isModalOpen, setModalOpen] = useDocumentationStore((s) =>
    ...
    return (
        ...
        >
            <ModalHeader title={component?.component.title}/>
            <ModalBody>
                <Flex direction={{default: 'column'}} key={component?.component.name}
                    ...
                    <Content component="p" className="description">{component?.component.description}</Content>
                    <Tabs
                        activeKey={tab}
