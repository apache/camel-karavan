...
import {APPLICATION_PROPERTIES, DOCKER_COMPOSE, DOCKER_STACK, getProjectFileTypeByNameTitle, getProjectFileTypeTitle, ProjectFile, ProjectType} from "@/api/ProjectModels";
...
export function FilesTab() {
    ...
    function canDeleteFiles(filename: string): boolean {
        ...
        return ![APPLICATION_PROPERTIES, DOCKER_COMPOSE, DOCKER_STACK].includes(filename);
    }
    ...
    function forOtherEnvironment(filename: string): boolean {
        ...
        if (filename.endsWith(".jkube.yaml") || filename.endsWith("." + DOCKER_COMPOSE) || filename.endsWith("." + DOCKER_STACK)) {
