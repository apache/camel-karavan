...
export function ModalConfirmation(props: Props) {
    ...
    const {title, isOpen, message, onConfirm, onCancel, btnConfirm, btnCancel, btnConfirmVariant, btnCancelVariant} = props;
    return (
        <Modal
            ...
            actions={[
                ...
                <Button key="cancel" variant={btnCancelVariant} onClick={e => onCancel()}>
                    {btnCancel || 'Cancel'}
                </Button>
            ]}
