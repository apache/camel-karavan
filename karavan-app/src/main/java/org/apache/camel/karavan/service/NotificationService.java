...
public class NotificationService {
    ...
    private static final Map<String, SseEventSink> sinkMap = new ConcurrentHashMap<>();

    public void sinkCleanup(String service, String username, SseEventSink eventSink) {
