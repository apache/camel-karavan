...
export class BuilderPage extends React.Component<Props, State> {
    ...
    getProjectForm() {
        return (
            <Card isCompact style={{width: "100%"}}>
    ...
    getPackageForm() {
        ...
        return <Card isCompact style={{width: "100%"}}>
            ...
            <CardBody className={uberJar ? "" : "card-disabled"}>
                <Form isHorizontal>
                    ...
                    <FileSelector files={this.props.files} filesSelected={filesSelected} onChange={filesSelected => this.setState({filesSelected: filesSelected})}/>
                </Form>
            </CardBody>
        </Card>
    }
    ...
    getProgressIcon(status: 'pending' | 'progress' | 'done' | 'error') {
        switch (status){
            ...
            case "progress": return <InProgressIcon/>;
        ...
        return (<Card isCompact style={{width: "100%"}}>
            <CardBody>
                <Flex justifyContent={{default: 'justifyContentSpaceBetween'}}>
                    ...
                    <FlexItem style={{margin: "auto", height:"60px"}}>
    ...
    getCenter() {
        return (
            <PageSection variant={this.props.dark ? PageSectionVariants.darker : PageSectionVariants.light} padding={{default: 'padding'}}>
    ...
    render() {
        return (
            <PageSection className="project-tools" variant={this.props.dark ? PageSectionVariants.darker : PageSectionVariants.light} padding={{default: 'noPadding'}}>
