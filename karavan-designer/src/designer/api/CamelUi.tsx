...
const DslLabels = ["consumer", "producer", "routing", "transformation", "error", "configuration"];
const defaultIcon =
...
export class CamelUi {
    ...
    static getTitle = (element: CamelElement): string => {
        ...
        if (k) {
            ...
            return uri ? uri : CamelUi.capitalizeName(element.dslName);
        }
    };
