...
export const DataFormats: [string, string, string][] = [
    ...
    ['jacksonXml','Jackson XML',"Unmarshal a XML payloads to POJOs and back using XMLMapper extension of Jackson."],
...
export const CamelDataFormatMetadata: ElementMeta[] = [
    ...
    new ElementMeta('univocityFixed', 'UniVocityFixedDataFormat', 'uniVocity Fixed Length', "Marshal and unmarshal Java objects from and to fixed length records using UniVocity Parsers.", 'dataformat,transformation,csv', [
        ...
        new PropertyMeta('comment', 'Comment', "The comment symbol. The default value is #", 'string', '', '#', false, false, false, false),
        new PropertyMeta('emptyValue', 'Empty Value', "The String representation of an empty value", 'string', '', '', false, false, false, false),
        ...
        new PropertyMeta('lineSeparator', 'Line Separator', "The line separator of the files The default value is to use the JVM platform line separator", 'string', '', '', false, false, false, false),
        ...
        new PropertyMeta('nullValue', 'Null Value', "The string representation of a null value. The default value is null", 'string', '', '', false, false, false, false),
        new PropertyMeta('numberOfRecordsToRead', 'Number Of Records To Read', "The maximum number of record to read.", 'number', '', '', false, false, false, false),
    ...
    new ElementMeta('jacksonXml', 'JacksonXMLDataFormat', 'Jackson XML', "Unmarshal a XML payloads to POJOs and back using XMLMapper extension of Jackson.", 'dataformat,transformation,xml', [
        new PropertyMeta('allowJmsType', 'Allow Jms Type', "Used for JMS users to allow the JMSType header from the JMS spec to specify a FQN classname to use to unmarshal to.", 'boolean', '', 'false', false, false, false, false),
        new PropertyMeta('allowUnmarshallType', 'Allow Unmarshall Type', "If enabled then Jackson is allowed to attempt to use the CamelJacksonUnmarshalType header during the unmarshalling. This should only be enabled when desired to be used.", 'boolean', '', 'false', false, false, false, false),
        new PropertyMeta('collectionType', 'Collection Type', "Refers to a custom collection type to lookup in the registry to use. This option should rarely be used, but allows to use different collection types than java.util.Collection based as default.", 'string', '', '', false, false, false, false),
        new PropertyMeta('contentTypeHeader', 'Content Type Header', "Whether the data format should set the Content-Type header with the type from the data format. For example application/xml for data formats marshalling to XML, or application/json for data formats marshalling to JSON", 'boolean', '', 'true', false, false, false, false),
    ...
    new ElementMeta('xmlSecurity', 'XMLSecurityDataFormat', 'XML Security', "Encrypt and decrypt XML payloads using Apache Santuario.", 'dataformat,transformation,xml', [
        ...
        new PropertyMeta('digestAlgorithm', 'Digest Algorithm', "The digest algorithm to use with the RSA OAEP algorithm. The available choices are: XMLCipher.SHA1 XMLCipher.SHA256 XMLCipher.SHA512 The default value is XMLCipher.SHA1", 'string', '', 'SHA1', false, false, false, false),
        new PropertyMeta('id', 'Id', "The id of this node", 'string', '', '', false, false, false, false),
        new PropertyMeta('keyCipherAlgorithm', 'Key Cipher Algorithm', "The cipher algorithm to be used for encryption/decryption of the asymmetric key. The available choices are: XMLCipher.RSA_v1dot5 XMLCipher.RSA_OAEP XMLCipher.RSA_OAEP_11 The default value is XMLCipher.RSA_OAEP", 'string', '', 'RSA_OAEP', false, false, false, false),
        ...
        new PropertyMeta('mgfAlgorithm', 'Mgf Algorithm', "The MGF Algorithm to use with the RSA OAEP algorithm. The available choices are: EncryptionConstants.MGF1_SHA1 EncryptionConstants.MGF1_SHA256 EncryptionConstants.MGF1_SHA512 The default value is EncryptionConstants.MGF1_SHA1", 'string', '', 'MGF1_SHA1', false, false, false, false),
    ...
    new ElementMeta('zipDeflater', 'ZipDeflaterDataFormat', 'Zip Deflater', "Compress and decompress streams using java.util.zip.Deflater and java.util.zip.Inflater.", 'dataformat,transformation', [
        new PropertyMeta('compressionLevel', 'Compression Level', "To specify a specific compression between 0-9. -1 is default compression, 0 is no compression, and 9 is the best compression.", 'number', '', '-1', false, false, false, false),
        new PropertyMeta('id', 'Id', "The id of this node", 'string', '', '', false, false, false, false),
    ]),
    ...
    new ElementMeta('yaml', 'YAMLDataFormat', 'YAML', "Marshal and unmarshal Java objects to and from YAML.", 'dataformat,transformation,yaml', [
        ...
        new PropertyMeta('maxAliasesForCollections', 'Max Aliases For Collections', "Set the maximum amount of aliases allowed for collections.", 'number', '', '50', false, false, false, false),
    ...
    new ElementMeta('univocityTsv', 'UniVocityTsvDataFormat', 'uniVocity TSV', "Marshal and unmarshal Java objects from and to TSV (Tab-Separated Values) records using UniVocity Parsers.", 'dataformat,transformation,csv', [
        ...
        new PropertyMeta('comment', 'Comment', "The comment symbol. The default value is #", 'string', '', '#', false, false, false, false),
        new PropertyMeta('emptyValue', 'Empty Value', "The String representation of an empty value", 'string', '', '', false, false, false, false),
        new PropertyMeta('escapeChar', 'Escape Char', "The escape character.", 'string', '', '\\', false, false, false, false),
        new PropertyMeta('headerExtractionEnabled', 'Header Extraction Enabled', "Whether or not the header must be read in the first line of the test document The default value is false", 'boolean', '', 'false', false, false, false, false),
        new PropertyMeta('headersDisabled', 'Headers Disabled', "Whether or not the headers are disabled. When defined, this option explicitly sets the headers as null which indicates that there is no header. The default value is false", 'boolean', '', 'false', false, false, false, false),
        new PropertyMeta('id', 'Id', "The id of this node", 'string', '', '', false, false, false, false),
        new PropertyMeta('ignoreLeadingWhitespaces', 'Ignore Leading Whitespaces', "Whether or not the leading white spaces must be ignored. The default value is true", 'boolean', '', 'true', false, false, false, false),
    ...
    new ElementMeta('univocityCsv', 'UniVocityCsvDataFormat', 'uniVocity CSV', "Marshal and unmarshal Java objects from and to CSV (Comma Separated Values) using UniVocity Parsers.", 'dataformat,transformation,csv', [
        ...
        new PropertyMeta('nullValue', 'Null Value', "The string representation of a null value. The default value is null", 'string', '', '', false, false, false, false),
        new PropertyMeta('numberOfRecordsToRead', 'Number Of Records To Read', "The maximum number of record to read.", 'number', '', '', false, false, false, false),
        new PropertyMeta('quote', 'Quote', "The quote symbol.", 'string', '', '"', false, false, false, false),
        ...
        new PropertyMeta('quoteEscape', 'Quote Escape', "The quote escape symbol", 'string', '', '"', false, false, false, false),
        new PropertyMeta('skipEmptyLines', 'Skip Empty Lines', "Whether or not the empty lines must be ignored. The default value is true", 'boolean', '', 'true', false, false, false, false),
        new PropertyMeta('univocityHeader', 'univocityHeader', "univocityHeader", 'UniVocityHeader', '', '', false, false, true, true),
    ]),
...
export const CamelLanguageMetadata: ElementMeta[] = [
    new ElementMeta('xpath', 'XPathExpression', 'XPath', "Evaluates an XPath expression against an XML payload.", 'language,core,xml', [
        ...
        new PropertyMeta('factoryRef', 'Factory Ref', "References to a custom XPathFactory to lookup in the registry", 'string', '', '', false, false, false, false),
        ...
        new PropertyMeta('objectModel', 'Object Model', "The XPath object model to use", 'string', '', '', false, false, false, false),
        new PropertyMeta('preCompile', 'Pre Compile', "Whether to enable pre-compiling the xpath expression during initialization phase. pre-compile is enabled by default. This can be used to turn off, for example in cases the compilation phase is desired at the starting phase, such as if the application is ahead of time compiled (for example with camel-quarkus) which would then load the xpath factory of the built operating system, and not a JVM runtime.", 'boolean', '', 'true', false, false, false, false),
...
export const CamelModelMetadata: ElementMeta[] = [
    ...
    new ElementMeta('restConfiguration', 'RestConfigurationDefinition', 'Rest Configuration', "To configure rest", 'rest', [
        new PropertyMeta('apiComponent', 'Api Component', "The name of the Camel component to use as the REST API. If no API Component has been explicit configured, then Camel will lookup if there is a Camel component responsible for servicing and generating the REST API documentation, or if a org.apache.camel.spi.RestApiProcessorFactory is registered in the registry. If either one is found, then that is being used.", 'string', '', '', false, false, false, false),
        new PropertyMeta('apiContextIdPattern', 'Api Context Id Pattern', "Sets an CamelContext id pattern to only allow Rest APIs from rest services within CamelContext's which name matches the pattern. The pattern #name# refers to the CamelContext name, to match on the current CamelContext only. For any other value, the pattern uses the rules from PatternHelper#matchPattern(String,String)", 'string', '', '', false, false, false, false),
        new PropertyMeta('apiContextListing', 'Api Context Listing', "Sets whether listing of all available CamelContext's with REST services in the JVM is enabled. If enabled it allows to discover these contexts, if false then only the current CamelContext is in use.", 'boolean', '', 'false', false, false, false, false),
        new PropertyMeta('apiContextPath', 'Api Context Path', "Sets a leading API context-path the REST API services will be using. This can be used when using components such as camel-servlet where the deployed web application is deployed using a context-path.", 'string', '', '', false, false, false, false),
        new PropertyMeta('apiContextRouteId', 'Api Context Route Id', "Sets the route id to use for the route that services the REST API. The route will by default use an auto assigned route id.", 'string', '', '', false, false, false, false),
        new PropertyMeta('apiHost', 'Api Host', "To use a specific hostname for the API documentation (such as swagger or openapi) This can be used to override the generated host with this configured hostname", 'string', '', '', false, false, false, false),
        new PropertyMeta('apiProperty', 'Api Property', "Allows to configure as many additional properties for the api documentation. For example set property api.title to my cool stuff", 'RestPropertyDefinition', '', '', false, false, true, true),
        new PropertyMeta('apiVendorExtension', 'Api Vendor Extension', "Whether vendor extension is enabled in the Rest APIs. If enabled then Camel will include additional information as vendor extension (eg keys starting with x-) such as route ids, class names etc. Not all 3rd party API gateways and tools supports vendor-extensions when importing your API docs.", 'boolean', '', 'false', false, false, false, false),
        new PropertyMeta('bindingMode', 'Binding Mode', "Sets the binding mode to use. The default value is off", 'string', 'auto, json, json-xml, off, xml', 'off', false, false, false, false),
        new PropertyMeta('clientRequestValidation', 'Client Request Validation', "Whether to enable validation of the client request to check: 1) Content-Type header matches what the Rest DSL consumes; returns HTTP Status 415 if validation error. 2) Accept header matches what the Rest DSL produces; returns HTTP Status 406 if validation error. 3) Missing required data (query parameters, HTTP headers, body); returns HTTP Status 400 if validation error. 4) Parsing error of the message body (JSon, XML or Auto binding mode must be enabled); returns HTTP Status 400 if validation error.", 'boolean', '', 'false', false, false, false, false),
        new PropertyMeta('component', 'Component', "The Camel Rest component to use for the REST transport (consumer), such as netty-http, jetty, servlet, undertow. If no component has been explicit configured, then Camel will lookup if there is a Camel component that integrates with the Rest DSL, or if a org.apache.camel.spi.RestConsumerFactory is registered in the registry. If either one is found, then that is being used.", 'string', '', '', false, false, false, false),
        new PropertyMeta('componentProperty', 'Component Property', "Allows to configure as many additional properties for the rest component in use.", 'RestPropertyDefinition', '', '', false, false, true, true),
        new PropertyMeta('consumerProperty', 'Consumer Property', "Allows to configure as many additional properties for the rest consumer in use.", 'RestPropertyDefinition', '', '', false, false, true, true),
        new PropertyMeta('contextPath', 'Context Path', "Sets a leading context-path the REST services will be using. This can be used when using components such as camel-servlet where the deployed web application is deployed using a context-path. Or for components such as camel-jetty or camel-netty-http that includes a HTTP server.", 'string', '', '', false, false, false, false),
        new PropertyMeta('corsHeaders', 'Cors Headers', "Allows to configure custom CORS headers.", 'RestPropertyDefinition', '', '', false, false, true, true),
        new PropertyMeta('dataFormatProperty', 'Data Format Property', "Allows to configure as many additional properties for the data formats in use. For example set property prettyPrint to true to have json outputted in pretty mode. The properties can be prefixed to denote the option is only for either JSON or XML and for either the IN or the OUT. The prefixes are: json.in. json.out. xml.in. xml.out. For example a key with value xml.out.mustBeJAXBElement is only for the XML data format for the outgoing. A key without a prefix is a common key for all situations.", 'RestPropertyDefinition', '', '', false, false, true, true),
        new PropertyMeta('enableCors', 'enableCors', "enableCors", 'boolean', '', '', false, false, false, false),
        new PropertyMeta('endpointProperty', 'Endpoint Property', "Allows to configure as many additional properties for the rest endpoint in use.", 'RestPropertyDefinition', '', '', false, false, true, true),
        new PropertyMeta('host', 'Host', "The hostname to use for exposing the REST service.", 'string', '', '', false, false, false, false),
        new PropertyMeta('hostNameResolver', 'Host Name Resolver', "If no hostname has been explicit configured, then this resolver is used to compute the hostname the REST service will be using.", 'string', 'all-local-ip, local-host-name, local-ip', '', false, false, false, false),
        new PropertyMeta('jsonDataFormat', 'Json Data Format', "Name of specific json data format to use. By default jackson will be used. Important: This option is only for setting a custom name of the data format, not to refer to an existing data format instance.", 'string', '', '', false, false, false, false),
        ...
        new PropertyMeta('producerApiDoc', 'Producer Api Doc', "Sets the location of the api document the REST producer will use to validate the REST uri and query parameters are valid accordingly to the api document. The location of the api document is loaded from classpath by default, but you can use file: or http: to refer to resources to load from file or http url.", 'string', '', '', false, false, false, false),
        new PropertyMeta('producerComponent', 'Producer Component', "Sets the name of the Camel component to use as the REST producer", 'string', '', '', false, false, false, false),
        ...
        new PropertyMeta('skipBindingOnErrorCode', 'Skip Binding On Error Code', "Whether to skip binding on output if there is a custom HTTP error code header. This allows to build custom error messages that do not bind to json / xml etc, as success messages otherwise will do.", 'boolean', '', 'false', false, false, false, false),
        new PropertyMeta('useXForwardHeaders', 'Use XForward Headers', "Whether to use X-Forward headers for Host and related setting. The default value is true.", 'boolean', '', 'true', false, false, false, false),
        new PropertyMeta('xmlDataFormat', 'Xml Data Format', "Name of specific XML data format to use. By default jaxb will be used. Important: This option is only for setting a custom name of the data format, not to refer to an existing data format instance.", 'string', '', '', false, false, false, false),
    ]),
    new ElementMeta('saga', 'SagaDefinition', 'Saga', "Enables Sagas on the route", 'eip,routing', [
        new PropertyMeta('compensation', 'Compensation', "The compensation endpoint URI that must be called to compensate all changes done in the route. The route corresponding to the compensation URI must perform compensation and complete without error. If errors occur during compensation, the saga service may call again the compensation URI to retry.", 'SagaActionUriDefinition', '', '', false, false, false, true),
        new PropertyMeta('completion', 'Completion', "The completion endpoint URI that will be called when the Saga is completed successfully. The route corresponding to the completion URI must perform completion tasks and terminate without error. If errors occur during completion, the saga service may call again the completion URI to retry.", 'SagaActionUriDefinition', '', '', false, false, false, true),
    ...
    new ElementMeta('faultToleranceConfiguration', 'FaultToleranceConfigurationDefinition', 'Fault Tolerance Configuration', "MicroProfile Fault Tolerance Circuit Breaker EIP configuration", 'configuration,eip', [
        ...
        new PropertyMeta('bulkheadExecutorServiceRef', 'Bulkhead Executor Service Ref', "References to a custom thread pool to use when bulkhead is enabled.", 'string', '', '', false, false, false, false),
        new PropertyMeta('bulkheadMaxConcurrentCalls', 'Bulkhead Max Concurrent Calls', "Configures the max amount of concurrent calls the bulkhead will support.", 'number', '', '10', false, false, false, false),
        new PropertyMeta('bulkheadWaitingTaskQueue', 'Bulkhead Waiting Task Queue', "Configures the task queue size for holding waiting tasks to be processed by the bulkhead.", 'number', '', '10', false, false, false, false),
        new PropertyMeta('circuitBreakerRef', 'Circuit Breaker Ref', "Refers to an existing io.smallrye.faulttolerance.core.circuit.breaker.CircuitBreaker instance to lookup and use from the registry. When using this, then any other circuit breaker options are not in use.", 'string', '', '', false, false, false, false),
        ...
        new PropertyMeta('timeoutPoolSize', 'Timeout Pool Size', "Configures the pool size of the thread pool when timeout is enabled. Default value is 10.", 'number', '', '10', false, false, false, false),
        new PropertyMeta('timeoutScheduledExecutorServiceRef', 'Timeout Scheduled Executor Service Ref', "References to a custom thread pool to use when timeout is enabled", 'string', '', '', false, false, false, false),
    ]),
    ...
    new ElementMeta('restBinding', 'RestBindingDefinition', 'Rest Binding', "To configure rest binding", 'rest', [
        new PropertyMeta('bindingMode', 'Binding Mode', "Sets the binding mode to use. The default value is off", 'string', '', 'off', false, false, false, false),
        new PropertyMeta('clientRequestValidation', 'Client Request Validation', "Whether to enable validation of the client request to check: 1) Content-Type header matches what the Rest DSL consumes; returns HTTP Status 415 if validation error. 2) Accept header matches what the Rest DSL produces; returns HTTP Status 406 if validation error. 3) Missing required data (query parameters, HTTP headers, body); returns HTTP Status 400 if validation error. 4) Parsing error of the message body (JSon, XML or Auto binding mode must be enabled); returns HTTP Status 400 if validation error.", 'string', '', '', false, false, false, false),
        new PropertyMeta('component', 'Component', "Sets the component name that this definition will apply to", 'string', '', '', false, false, false, false),
        ...
        new PropertyMeta('description', 'Description', "Sets the description of this node", 'string', '', '', false, false, false, false),
        new PropertyMeta('enableCors', 'enableCors', "enableCors", 'string', '', '', false, false, false, false),
        new PropertyMeta('id', 'Id', "Sets the id of this node", 'string', '', '', false, false, false, false),
        new PropertyMeta('outType', 'Out Type', "Sets the class name to use for binding from POJO to output for the outgoing data The name of the class of the input data. Append a to the end of the name if you want the input to be an array type.", 'string', '', '', false, false, false, false),
        ...
        new PropertyMeta('skipBindingOnErrorCode', 'Skip Binding On Error Code', "Whether to skip binding on output if there is a custom HTTP error code header. This allows to build custom error messages that do not bind to json / xml etc, as success messages otherwise will do.", 'string', '', '', false, false, false, false),
        new PropertyMeta('type', 'Type', "Sets the class name to use for binding from input to POJO for the incoming data The name of the class of the input data. Append a to the end of the name if you want the input to be an array type.", 'string', '', '', false, false, false, false),
    ]),
    ...
    new ElementMeta('circuitBreaker', 'CircuitBreakerDefinition', 'Circuit Breaker', "Route messages in a fault tolerance way using Circuit Breaker", 'eip,routing', [
        ...
        new PropertyMeta('hystrixConfiguration', 'Hystrix Configuration', "Configures the circuit breaker to use Hystrix with the given configuration.", 'HystrixConfigurationDefinition', '', '', false, false, false, true),
        new PropertyMeta('id', 'Id', "Sets the id of this node", 'string', '', '', false, false, false, false),
    ...
    new ElementMeta('resilience4jConfiguration', 'Resilience4jConfigurationDefinition', 'Resilience4j Configuration', "Resilience4j Circuit Breaker EIP configuration", 'configuration,eip', [
        new PropertyMeta('automaticTransitionFromOpenToHalfOpenEnabled', 'Automatic Transition From Open To Half Open Enabled', "Enables automatic transition from OPEN to HALF_OPEN state once the waitDurationInOpenState has passed.", 'boolean', '', 'false', false, false, false, false),
        new PropertyMeta('circuitBreakerRef', 'Circuit Breaker Ref', "Refers to an existing io.github.resilience4j.circuitbreaker.CircuitBreaker instance to lookup and use from the registry. When using this, then any other circuit breaker options are not in use.", 'string', '', '', false, false, false, false),
        new PropertyMeta('configRef', 'Config Ref', "Refers to an existing io.github.resilience4j.circuitbreaker.CircuitBreakerConfig instance to lookup and use from the registry.", 'string', '', '', false, false, false, false),
        ...
        new PropertyMeta('permittedNumberOfCallsInHalfOpenState', 'Permitted Number Of Calls In Half Open State', "Configures the number of permitted calls when the CircuitBreaker is half open. The size must be greater than 0. Default size is 10.", 'number', '', '10', false, false, false, false),
        ...
        new PropertyMeta('slidingWindowType', 'Sliding Window Type', "Configures the type of the sliding window which is used to record the outcome of calls when the CircuitBreaker is closed. Sliding window can either be count-based or time-based. If slidingWindowType is COUNT_BASED, the last slidingWindowSize calls are recorded and aggregated. If slidingWindowType is TIME_BASED, the calls of the last slidingWindowSize seconds are recorded and aggregated. Default slidingWindowType is COUNT_BASED.", 'string', 'TIME_BASED, COUNT_BASED', 'COUNT_BASED', false, false, false, false),
        new PropertyMeta('slowCallDurationThreshold', 'Slow Call Duration Threshold', "Configures the duration threshold (seconds) above which calls are considered as slow and increase the slow calls percentage. Default value is 60 seconds.", 'number', '', '60', false, false, false, false),
        new PropertyMeta('slowCallRateThreshold', 'Slow Call Rate Threshold', "Configures a threshold in percentage. The CircuitBreaker considers a call as slow when the call duration is greater than slowCallDurationThreshold Duration. When the percentage of slow calls is equal or greater the threshold, the CircuitBreaker transitions to open and starts short-circuiting calls. The threshold must be greater than 0 and not greater than 100. Default value is 100 percentage which means that all recorded calls must be slower than slowCallDurationThreshold.", 'number', '', '100', false, false, false, false),
        new PropertyMeta('waitDurationInOpenState', 'Wait Duration In Open State', "Configures the wait duration (in seconds) which specifies how long the CircuitBreaker should stay open, before it switches to half open. Default value is 60 seconds.", 'number', '', '60', false, false, false, false),
    ...
    new ElementMeta('description', 'DescriptionDefinition', 'Description', "To provide comments about the node.", 'configuration', [
        new PropertyMeta('lang', 'Lang', "Language, such as en for english.", 'string', '', '', false, false, false, false),
    ...
    new ElementMeta('errorHandler', 'ErrorHandlerBuilderRef', 'Error Handler', "Error handler settings", 'spring,configuration,error', [
        new PropertyMeta('deadLetterChannel', 'deadLetterChannel', "deadLetterChannel", 'DeadLetterChannelBuilder', '', '', false, false, false, true),
        new PropertyMeta('log', 'log', "log", 'DefaultErrorHandlerBuilder', '', '', false, false, false, true),
        new PropertyMeta('none', 'none', "none", 'NoErrorHandlerBuilder', '', '', false, false, false, true),
    ...
    new ElementMeta('serviceCallConfiguration', 'ServiceCallConfigurationDefinition', 'Service Call Configuration', "Remote service call configuration", 'routing,cloud', [
        ...
        new PropertyMeta('etcdServiceDiscovery', 'etcdServiceDiscovery', "etcdServiceDiscovery", 'EtcdServiceCallServiceDiscoveryConfiguration', '', '', false, false, false, true),
        ...
        new PropertyMeta('pattern', 'Pattern', "Sets the optional ExchangePattern used to invoke this endpoint", 'string', 'InOnly, InOut, InOptionalOut', '', false, false, false, false),
        new PropertyMeta('ribbonLoadBalancer', 'ribbonLoadBalancer', "ribbonLoadBalancer", 'RibbonServiceCallServiceLoadBalancerConfiguration', '', '', false, false, false, true),
    ...
    new ElementMeta('pollEnrich', 'PollEnrichDefinition', 'Poll Enrich', "Enriches messages with data polled from a secondary resource", 'eip,routing', [
        new PropertyMeta('aggregateOnException', 'Aggregate On Exception', "If this option is false then the aggregate method is not used if there was an exception thrown while trying to retrieve the data to enrich from the resource. Setting this option to true allows end users to control what to do if there was an exception in the aggregate method. For example to suppress the exception or set a custom message body etc.", 'boolean', '', 'false', false, false, false, false),
    ...
    new ElementMeta('aggregate', 'AggregateDefinition', 'Aggregate', "Aggregates many messages into a single message", 'eip,routing', [
        ...
        new PropertyMeta('completionPredicate', 'Completion Predicate', "A Predicate to indicate when an aggregated exchange is complete. If this is not specified and the AggregationStrategy object implements Predicate, the aggregationStrategy object will be used as the completionPredicate.", 'ExpressionSubElementDefinition', '', '', false, false, false, true),
        ...
        new PropertyMeta('completionTimeoutExpression', 'Completion Timeout Expression', "Time in millis that an aggregated exchange should be inactive before its complete (timeout). This option can be set as either a fixed value or using an Expression which allows you to evaluate a timeout dynamically - will use Long as result. If both are set Camel will fallback to use the fixed value if the Expression result was null or 0. You cannot use this option together with completionInterval, only one of the two can be used. By default the timeout checker runs every second, you can use the completionTimeoutCheckerInterval option to configure how frequently to run the checker. The timeout is an approximation and there is no guarantee that the a timeout is triggered exactly after the timeout value. It is not recommended to use very low timeout values or checker intervals.", 'ExpressionSubElementDefinition', '', '', false, false, false, true),
        ...
        new PropertyMeta('optimisticLockRetryPolicy', 'Optimistic Lock Retry Policy', "Allows to configure retry settings when using optimistic locking.", 'OptimisticLockRetryPolicyDefinition', '', '', false, false, false, true),
    ...
    new ElementMeta('split', 'SplitDefinition', 'Split', "Splits a single message into many sub-messages.", 'eip,routing', [
        ...
        new PropertyMeta('description', 'Description', "Sets the description of this node", 'string', '', '', false, false, false, false),
        new PropertyMeta('executorServiceRef', 'Executor Service Ref', "Refers to a custom Thread Pool to be used for parallel processing. Notice if you set this option, then parallel processing is automatic implied, and you do not have to enable that option as well.", 'string', '', '', false, false, false, false),
        new PropertyMeta('expression', 'Expression', "Expression of how to split the message body, such as as-is, using a tokenizer, or using an xpath.", 'ExpressionDefinition', '', '', true, false, false, true),
        new PropertyMeta('id', 'Id', "Sets the id of this node", 'string', '', '', false, false, false, false),
        ...
        new PropertyMeta('parallelProcessing', 'Parallel Processing', "If enabled then processing each split messages occurs concurrently. Note the caller thread will still wait until all messages has been fully processed, before it continues. Its only processing the sub messages from the splitter which happens concurrently.", 'boolean', '', 'false', false, false, false, false),
        new PropertyMeta('shareUnitOfWork', 'Share Unit Of Work', "Shares the org.apache.camel.spi.UnitOfWork with the parent and each of the sub messages. Splitter will by default not share unit of work between the parent exchange and each split exchange. This means each split exchange has its own individual unit of work.", 'boolean', '', 'false', false, false, false, false),
        new PropertyMeta('steps', 'steps', "steps", 'CamelElement', '', '', false, false, true, true),
        new PropertyMeta('stopOnAggregateException', 'Stop On Aggregate Exception', "If enabled, unwind exceptions occurring at aggregation time to the error handler when parallelProcessing is used. The default value is false for the sake of backward compatibility.", 'boolean', '', 'false', false, false, false, false),
    ...
    new ElementMeta('verb', 'VerbDefinition', 'Verb', "Rest command", 'rest', [
        new PropertyMeta('apiDocs', 'Api Docs', "Whether to include or exclude the VerbDefinition in API documentation. The default value is true.", 'string', '', '', false, false, false, false),
        new PropertyMeta('bindingMode', 'Binding Mode', "Sets the binding mode to use. This option will override what may be configured on a parent level The default value is auto", 'string', '', 'auto', false, false, false, false),
        new PropertyMeta('clientRequestValidation', 'Client Request Validation', "Whether to enable validation of the client request to check: 1) Content-Type header matches what the Rest DSL consumes; returns HTTP Status 415 if validation error. 2) Accept header matches what the Rest DSL produces; returns HTTP Status 406 if validation error. 3) Missing required data (query parameters, HTTP headers, body); returns HTTP Status 400 if validation error. 4) Parsing error of the message body (JSon, XML or Auto binding mode must be enabled); returns HTTP Status 400 if validation error.", 'string', '', '', false, false, false, false),
        ...
        new PropertyMeta('deprecated', 'Deprecated', "Sets deprecated flag in openapi", 'boolean', '', 'false', false, false, false, false),
        new PropertyMeta('description', 'Description', "Sets the description of this node", 'string', '', '', false, false, false, false),
        new PropertyMeta('enableCors', 'enableCors', "enableCors", 'string', '', '', false, false, false, false),
        new PropertyMeta('id', 'Id', "Sets the id of this node", 'string', '', '', false, false, false, false),
        new PropertyMeta('method', 'Method', "The HTTP verb such as GET, POST, DELETE, etc.", 'string', '', '', false, false, false, false),
        new PropertyMeta('outType', 'Out Type', "Sets the class name to use for binding from POJO to output for the outgoing data This option will override what may be configured on a parent level The name of the class of the input data. Append a to the end of the name if you want the input to be an array type.", 'string', '', '', false, false, false, false),
        new PropertyMeta('param', 'param', "param", 'RestOperationParamDefinition', '', '', false, false, true, true),
        ...
        new PropertyMeta('responseMessage', 'responseMessage', "responseMessage", 'RestOperationResponseMsgDefinition', '', '', false, false, true, true),
        new PropertyMeta('route', 'route', "route", 'RouteDefinition', '', '', false, false, false, true),
        new PropertyMeta('routeId', 'Route Id', "The route id this rest-dsl is using (read-only)", 'string', '', '', false, false, false, false),
        new PropertyMeta('security', 'security', "security", 'SecurityDefinition', '', '', false, false, true, true),
        new PropertyMeta('skipBindingOnErrorCode', 'Skip Binding On Error Code', "Whether to skip binding on output if there is a custom HTTP error code header. This allows to build custom error messages that do not bind to json / xml etc, as success messages otherwise will do. This option will override what may be configured on a parent level", 'string', '', '', false, false, false, false),
        new PropertyMeta('steps', 'steps', "steps", 'CamelElement', '', '', false, false, true, true),
        new PropertyMeta('to', 'to', "to", 'ToDefinition', '', '', false, false, false, true),
        new PropertyMeta('toD', 'toD', "toD", 'ToDynamicDefinition', '', '', false, false, false, true),
        new PropertyMeta('type', 'Type', "Sets the class name to use for binding from input to POJO for the incoming data This option will override what may be configured on a parent level. The name of the class of the input data. Append a to the end of the name if you want the input to be an array type.", 'string', '', '', false, false, false, false),
        new PropertyMeta('uri', 'Uri', "Uri template of this REST service such as /{id}.", 'string', '', '', false, false, false, false),
    ]),
    ...
    new ElementMeta('contextScan', 'ContextScanDefinition', 'Context Scan', "Scans for Java org.apache.camel.builder.RouteBuilder instances in the context org.apache.camel.spi.Registry .", 'configuration', [
        new PropertyMeta('excludes', 'Excludes', "Exclude finding route builder from these java package names.", 'string', '', '', false, false, true, true),
        new PropertyMeta('includeNonSingletons', 'Include Non Singletons', "Whether to include non-singleton beans (prototypes) By default only singleton beans is included in the context scan", 'boolean', '', 'false', false, false, false, false),
        new PropertyMeta('includes', 'Includes', "Include finding route builder from these java package names.", 'string', '', '', false, false, true, true),
    ]),
    new ElementMeta('wireTap', 'WireTapDefinition', 'Wire Tap', "Routes a copy of a message (or creates a new message) to a secondary destination while continue routing the original message.", 'eip,routing', [
        new PropertyMeta('allowOptimisedComponents', 'Allow Optimised Components', "Whether to allow components to optimise toD if they are org.apache.camel.spi.SendDynamicAware .", 'boolean', '', 'true', false, false, false, false),
        new PropertyMeta('autoStartComponents', 'Auto Start Components', "Whether to auto startup components when toD is starting up.", 'boolean', '', 'true', false, false, false, false),
        new PropertyMeta('body', 'Body', "Uses the expression for creating a new body as the message to use for wire tapping", 'ExpressionSubElementDefinition', '', '', false, false, false, true),
        new PropertyMeta('cacheSize', 'Cache Size', "Sets the maximum size used by the org.apache.camel.spi.ProducerCache which is used to cache and reuse producers when using this recipient list, when uris are reused. Beware that when using dynamic endpoints then it affects how well the cache can be utilized. If each dynamic endpoint is unique then its best to turn of caching by setting this to -1, which allows Camel to not cache both the producers and endpoints; they are regarded as prototype scoped and will be stopped and discarded after use. This reduces memory usage as otherwise producers/endpoints are stored in memory in the caches. However if there are a high degree of dynamic endpoints that have been used before, then it can benefit to use the cache to reuse both producers and endpoints and therefore the cache size can be set accordingly or rely on the default size (1000). If there is a mix of unique and used before dynamic endpoints, then setting a reasonable cache size can help reduce memory usage to avoid storing too many non frequent used producers.", 'number', '', '', false, false, false, false),
        ...
        new PropertyMeta('setHeader', 'setHeader', "setHeader", 'SetHeaderDefinition', '', '', false, false, true, true),
        new PropertyMeta('uri', 'Uri', "The uri of the endpoint to send to. The uri can be dynamic computed using the org.apache.camel.language.simple.SimpleLanguage expression.", 'string', '', '', true, false, false, false),
    ]),
    ...
    new ElementMeta('rest', 'RestDefinition', 'Rest', "Defines a rest service using the rest-dsl", 'rest', [
        new PropertyMeta('apiDocs', 'Api Docs', "Whether to include or exclude the VerbDefinition in API documentation. This option will override what may be configured on a parent level The default value is true.", 'string', '', '', false, false, false, false),
        new PropertyMeta('bindingMode', 'Binding Mode', "Sets the binding mode to use. This option will override what may be configured on a parent level The default value is auto", 'string', '', 'auto', false, false, false, false),
        new PropertyMeta('clientRequestValidation', 'Client Request Validation', "Whether to enable validation of the client request to check: 1) Content-Type header matches what the Rest DSL consumes; returns HTTP Status 415 if validation error. 2) Accept header matches what the Rest DSL produces; returns HTTP Status 406 if validation error. 3) Missing required data (query parameters, HTTP headers, body); returns HTTP Status 400 if validation error. 4) Parsing error of the message body (JSon, XML or Auto binding mode must be enabled); returns HTTP Status 400 if validation error.", 'string', '', '', false, false, false, false),
        new PropertyMeta('consumes', 'Consumes', "To define the content type what the REST service consumes (accept as input), such as application/xml or application/json. This option will override what may be configured on a parent level", 'string', '', '', false, false, false, false),
        new PropertyMeta('delete', 'delete', "delete", 'DeleteVerbDefinition', '', '', false, false, true, true),
        new PropertyMeta('description', 'Description', "Sets the description of this node", 'string', '', '', false, false, false, false),
        new PropertyMeta('enableCors', 'enableCors', "enableCors", 'string', '', '', false, false, false, false),
        new PropertyMeta('get', 'get', "get", 'GetVerbDefinition', '', '', false, false, true, true),
        new PropertyMeta('head', 'head', "head", 'HeadVerbDefinition', '', '', false, false, true, true),
        new PropertyMeta('id', 'Id', "Sets the id of this node", 'string', '', '', false, false, false, false),
        new PropertyMeta('patch', 'patch', "patch", 'PatchVerbDefinition', '', '', false, false, true, true),
        new PropertyMeta('path', 'Path', "Path of the rest service, such as /foo", 'string', '', '', false, false, false, false),
        new PropertyMeta('post', 'post', "post", 'PostVerbDefinition', '', '', false, false, true, true),
        new PropertyMeta('produces', 'Produces', "To define the content type what the REST service produces (uses for output), such as application/xml or application/json This option will override what may be configured on a parent level", 'string', '', '', false, false, false, false),
        new PropertyMeta('put', 'put', "put", 'PutVerbDefinition', '', '', false, false, true, true),
        new PropertyMeta('securityDefinitions', 'Security Definitions', "Sets the security definitions such as Basic, OAuth2 etc.", 'RestSecuritiesDefinition', '', '', false, false, false, true),
        new PropertyMeta('securityRequirements', 'Security Requirements', "Sets the security requirement(s) for all endpoints.", 'RestSecuritiesRequirement', '', '', false, false, false, true),
        new PropertyMeta('skipBindingOnErrorCode', 'Skip Binding On Error Code', "Whether to skip binding on output if there is a custom HTTP error code header. This allows to build custom error messages that do not bind to json / xml etc, as success messages otherwise will do. This option will override what may be configured on a parent level", 'string', '', '', false, false, false, false),
        ...
        new PropertyMeta('verb', 'verb', "verb", 'VerbDefinition', '', '', false, false, true, true),
    ]),
    ...
    new ElementMeta('hystrixConfiguration', 'HystrixConfigurationDefinition', 'Hystrix Configuration', "Hystrix Circuit Breaker EIP configuration", 'configuration,eip', [
        new PropertyMeta('allowMaximumSizeToDivergeFromCoreSize', 'Allow Maximum Size To Diverge From Core Size', "Allows the configuration for maximumSize to take effect. That value can then be equal to, or higher, than coreSize", 'boolean', '', 'false', false, false, false, false),
        new PropertyMeta('circuitBreakerEnabled', 'Circuit Breaker Enabled', "Whether to use a HystrixCircuitBreaker or not. If false no circuit-breaker logic will be used and all requests permitted. This is similar in effect to circuitBreakerForceClosed() except that continues tracking metrics and knowing whether it should be open/closed, this property results in not even instantiating a circuit-breaker.", 'boolean', '', 'true', false, false, false, false),
        new PropertyMeta('circuitBreakerErrorThresholdPercentage', 'Circuit Breaker Error Threshold Percentage', "Error percentage threshold (as whole number such as 50) at which point the circuit breaker will trip open and reject requests. It will stay tripped for the duration defined in circuitBreakerSleepWindowInMilliseconds; The error percentage this is compared against comes from HystrixCommandMetrics.getHealthCounts().", 'number', '', '50', false, false, false, false),
        new PropertyMeta('circuitBreakerForceClosed', 'Circuit Breaker Force Closed', "If true the HystrixCircuitBreaker#allowRequest() will always return true to allow requests regardless of the error percentage from HystrixCommandMetrics.getHealthCounts(). The circuitBreakerForceOpen() property takes precedence so if it set to true this property does nothing.", 'boolean', '', 'false', false, false, false, false),
        new PropertyMeta('circuitBreakerForceOpen', 'Circuit Breaker Force Open', "If true the HystrixCircuitBreaker.allowRequest() will always return false, causing the circuit to be open (tripped) and reject all requests. This property takes precedence over circuitBreakerForceClosed();", 'boolean', '', 'false', false, false, false, false),
        new PropertyMeta('circuitBreakerRequestVolumeThreshold', 'Circuit Breaker Request Volume Threshold', "Minimum number of requests in the metricsRollingStatisticalWindowInMilliseconds() that must exist before the HystrixCircuitBreaker will trip. If below this number the circuit will not trip regardless of error percentage.", 'number', '', '20', false, false, false, false),
        new PropertyMeta('circuitBreakerSleepWindowInMilliseconds', 'Circuit Breaker Sleep Window In Milliseconds', "The time in milliseconds after a HystrixCircuitBreaker trips open that it should wait before trying requests again.", 'number', '', '5000', false, false, false, false),
        new PropertyMeta('corePoolSize', 'Core Pool Size', "Core thread-pool size that gets passed to java.util.concurrent.ThreadPoolExecutor#setCorePoolSize(int)", 'number', '', '10', false, false, false, false),
        new PropertyMeta('executionIsolationSemaphoreMaxConcurrentRequests', 'Execution Isolation Semaphore Max Concurrent Requests', "Number of concurrent requests permitted to HystrixCommand.run(). Requests beyond the concurrent limit will be rejected. Applicable only when executionIsolationStrategy == SEMAPHORE.", 'number', '', '20', false, false, false, false),
        new PropertyMeta('executionIsolationStrategy', 'Execution Isolation Strategy', "What isolation strategy HystrixCommand.run() will be executed with. If THREAD then it will be executed on a separate thread and concurrent requests limited by the number of threads in the thread-pool. If SEMAPHORE then it will be executed on the calling thread and concurrent requests limited by the semaphore count.", 'string', 'THREAD, SEMAPHORE', 'THREAD', false, false, false, false),
        new PropertyMeta('executionIsolationThreadInterruptOnTimeout', 'Execution Isolation Thread Interrupt On Timeout', "Whether the execution thread should attempt an interrupt (using Future#cancel ) when a thread times out. Applicable only when executionIsolationStrategy() == THREAD.", 'boolean', '', 'true', false, false, false, false),
        new PropertyMeta('executionTimeoutEnabled', 'Execution Timeout Enabled', "Whether the timeout mechanism is enabled for this command", 'boolean', '', 'true', false, false, false, false),
        new PropertyMeta('executionTimeoutInMilliseconds', 'Execution Timeout In Milliseconds', "Time in milliseconds at which point the command will timeout and halt execution. If executionIsolationThreadInterruptOnTimeout == true and the command is thread-isolated, the executing thread will be interrupted. If the command is semaphore-isolated and a HystrixObservableCommand, that command will get unsubscribed.", 'number', '', '1000', false, false, false, false),
        new PropertyMeta('fallbackEnabled', 'Fallback Enabled', "Whether HystrixCommand.getFallback() should be attempted when failure occurs.", 'boolean', '', 'true', false, false, false, false),
        new PropertyMeta('fallbackIsolationSemaphoreMaxConcurrentRequests', 'Fallback Isolation Semaphore Max Concurrent Requests', "Number of concurrent requests permitted to HystrixCommand.getFallback(). Requests beyond the concurrent limit will fail-fast and not attempt retrieving a fallback.", 'number', '', '10', false, false, false, false),
        new PropertyMeta('groupKey', 'Group Key', "Sets the group key to use. The default value is CamelHystrix.", 'string', '', 'CamelHystrix', false, false, false, false),
        new PropertyMeta('id', 'Id', "The id of this node", 'string', '', '', false, false, false, false),
        new PropertyMeta('keepAliveTime', 'Keep Alive Time', "Keep-alive time in minutes that gets passed to ThreadPoolExecutor#setKeepAliveTime(long,TimeUnit)", 'number', '', '1', false, false, false, false),
        new PropertyMeta('maxQueueSize', 'Max Queue Size', "Max queue size that gets passed to BlockingQueue in HystrixConcurrencyStrategy.getBlockingQueue(int) This should only affect the instantiation of a threadpool - it is not eliglible to change a queue size on the fly. For that, use queueSizeRejectionThreshold().", 'number', '', '-1', false, false, false, false),
        new PropertyMeta('maximumSize', 'Maximum Size', "Maximum thread-pool size that gets passed to ThreadPoolExecutor#setMaximumPoolSize(int) . This is the maximum amount of concurrency that can be supported without starting to reject HystrixCommands. Please note that this setting only takes effect if you also set allowMaximumSizeToDivergeFromCoreSize", 'number', '', '10', false, false, false, false),
        new PropertyMeta('metricsHealthSnapshotIntervalInMilliseconds', 'Metrics Health Snapshot Interval In Milliseconds', "Time in milliseconds to wait between allowing health snapshots to be taken that calculate success and error percentages and affect HystrixCircuitBreaker.isOpen() status. On high-volume circuits the continual calculation of error percentage can become CPU intensive thus this controls how often it is calculated.", 'number', '', '500', false, false, false, false),
        new PropertyMeta('metricsRollingPercentileBucketSize', 'Metrics Rolling Percentile Bucket Size', "Maximum number of values stored in each bucket of the rolling percentile. This is passed into HystrixRollingPercentile inside HystrixCommandMetrics.", 'number', '', '10', false, false, false, false),
        new PropertyMeta('metricsRollingPercentileEnabled', 'Metrics Rolling Percentile Enabled', "Whether percentile metrics should be captured using HystrixRollingPercentile inside HystrixCommandMetrics.", 'boolean', '', 'true', false, false, false, false),
        new PropertyMeta('metricsRollingPercentileWindowBuckets', 'Metrics Rolling Percentile Window Buckets', "Number of buckets the rolling percentile window is broken into. This is passed into HystrixRollingPercentile inside HystrixCommandMetrics.", 'number', '', '6', false, false, false, false),
        new PropertyMeta('metricsRollingPercentileWindowInMilliseconds', 'Metrics Rolling Percentile Window In Milliseconds', "Duration of percentile rolling window in milliseconds. This is passed into HystrixRollingPercentile inside HystrixCommandMetrics.", 'number', '', '10000', false, false, false, false),
        new PropertyMeta('metricsRollingStatisticalWindowBuckets', 'Metrics Rolling Statistical Window Buckets', "Number of buckets the rolling statistical window is broken into. This is passed into HystrixRollingNumber inside HystrixCommandMetrics.", 'number', '', '10', false, false, false, false),
        new PropertyMeta('metricsRollingStatisticalWindowInMilliseconds', 'Metrics Rolling Statistical Window In Milliseconds', "This property sets the duration of the statistical rolling window, in milliseconds. This is how long metrics are kept for the thread pool. The window is divided into buckets and rolls by those increments.", 'number', '', '10000', false, false, false, false),
        new PropertyMeta('queueSizeRejectionThreshold', 'Queue Size Rejection Threshold', "Queue size rejection threshold is an artificial max size at which rejections will occur even if maxQueueSize has not been reached. This is done because the maxQueueSize of a BlockingQueue can not be dynamically changed and we want to support dynamically changing the queue size that affects rejections. This is used by HystrixCommand when queuing a thread for execution.", 'number', '', '5', false, false, false, false),
        new PropertyMeta('requestLogEnabled', 'Request Log Enabled', "Whether HystrixCommand execution and events should be logged to HystrixRequestLog.", 'boolean', '', 'true', false, false, false, false),
        new PropertyMeta('threadPoolKey', 'Thread Pool Key', "Sets the thread pool key to use. Will by default use the same value as groupKey has been configured to use.", 'string', '', 'CamelHystrix', false, false, false, false),
        new PropertyMeta('threadPoolRollingNumberStatisticalWindowBuckets', 'Thread Pool Rolling Number Statistical Window Buckets', "Number of buckets the rolling statistical window is broken into. This is passed into HystrixRollingNumber inside each HystrixThreadPoolMetrics instance.", 'number', '', '10', false, false, false, false),
        new PropertyMeta('threadPoolRollingNumberStatisticalWindowInMilliseconds', 'Thread Pool Rolling Number Statistical Window In Milliseconds', "Duration of statistical rolling window in milliseconds. This is passed into HystrixRollingNumber inside each HystrixThreadPoolMetrics instance.", 'number', '', '10000', false, false, false, false),
    ]),
]
