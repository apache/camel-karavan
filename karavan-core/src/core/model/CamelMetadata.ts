...
export const CamelLanguageMetadata: ElementMeta[] = [
    ...
    new ElementMeta('expression', 'ExpressionDefinition', 'Expression', "A useful base class for an expression", 'language', [
        ...
        new PropertyMeta('java', 'java', "java", 'null', '', '', false, false, false, false, '', ''),
        ...
        new PropertyMeta('variable', 'variable', "variable", 'null', '', '', false, false, false, false, '', ''),
        new PropertyMeta('wasm', 'wasm', "wasm", 'null', '', '', false, false, false, false, '', ''),
